...
export default function Footer() {
  return (
    <footer className="bg-white  border-t-2 max-w-7xl mx-auto border-gray-200 mt-20">
      <div className="max-w-6xl mx-auto px-6 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          {/* About */}
          <div>
            <h4 className="text-black font-bold text-base mb-3">About</h4>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-black font-bold text-base mb-3">Quick Links</h4>
          ...
          {/* Our Service */}
          <div>
            <h4 className="text-black font-bold text-base mb-3">Our Service</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-black font-bold text-base mb-3">Contact Info</h4>
        ...
        <div className="border-t w-[455px] mx-auto border-gray-200 pt-6">
          <p className="text-center text-gray-500 text-[16px] mb-[96px]">
