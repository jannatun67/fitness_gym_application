...
export default function Training() {
  return (
    <section className="bg-black text-white max-w-7xl mx-auto rounded-3xl py-12 md:py-20 px-6">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#57B233] hover:bg-[#4aa12d] transition text-white px-10 py-4 rounded-xl font-semibold shadow-lg"
            >
              Punch Now
            </motion.button>
